...
apt-get install rpi-stock-kernel-firmware sudo alsa-utils rt-tests psmisc acpid firmware-brcm80211 cpufrequtils console-common fake-hwclock ntp xserver-xorg xserver-xorg-video-fbdev xserver-xorg-input-libinput dbus-x11 policykit-1 lxde-core lightdm lxterminal alsamixergui jackd2 cdparanoia ffmpeg mpg123 id3v2 flac vorbis-tools xwax pideck usbmount whois --yes
